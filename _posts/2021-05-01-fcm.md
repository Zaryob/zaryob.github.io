...
![](https://cdn-images-1.medium.com/max/800/1*-rQtf5aWo_q0QDtXCSeXVg.png)

2\. Add project yazan butona tıklayalım. Önümüze açılan pencerede bize projemizin adı sorulacak.

![](https://cdn-images-1.medium.com/max/800/1*JoTfZKxob60kxB6hKj37zg.png)
...
![](https://cdn-images-1.medium.com/max/800/1*h_zcEsUPVVfgHy40jFVxZQ.png)

Şimdiki adımda ise bize analitics için kullanılacak kullanıcı sorulmakta. Ben öntanımlı Firebase kullanıcısını yaptım.

![](https://cdn-images-1.medium.com/max/800/1*Ec26oN3Hn-qXYk65Oq6ptg.png)
...
![](https://cdn-images-1.medium.com/max/800/1*ACVm7Tki9XLzm1rclB4nWg.png)
...
![](https://cdn-images-1.medium.com/max/800/1*vvBJyLW5p2KK_gB-Wfv6zQ.png)

Açılan ilk sayfamızda bizden bir firebase uygulaması oluşturmamızı tavsiye eden bir pencere bulunuyor.

![](https://cdn-images-1.medium.com/max/800/1*bS2WywfUtm-ZIyhocuZOJQ.png)

![](https://cdn-images-1.medium.com/max/600/1*i8hrW2FMBiPTHYjAiqbV9g.png)
...
![](https://cdn-images-1.medium.com/max/800/1*NAQ2R2WeHcdjbYzih1JMng.png)
...
![](https://cdn-images-1.medium.com/max/800/1*QpiVU3FWOtrT9A_N6SruUA.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/1*ucA5AIpWOcEO6JpmsFQ8-g.png)
...
![](https://cdn-images-1.medium.com/max/800/1*nMGo2ZeICZl_Wtj4-wqBXw.png)

**Register app** için tıkladığımızda bizim için bir config dosyası vermekte.

![](https://cdn-images-1.medium.com/max/800/1*u8-ZMk64ujH0j2XSKCDCmw.png)

Bunu indirelim ve projemizin içerisinde **android/app/** klasörü altına atalım.

![](https://cdn-images-1.medium.com/max/600/1*TfX9QqS_jEuzzbusOi)
...
![](https://cdn-images-1.medium.com/max/800/1*bhS9Vv83PLOpT7XwI279gQ.png)
...
![](https://cdn-images-1.medium.com/max/800/1*1p1t4UZDxZ5LwEPGMUa6vA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*QYQWe2xiewTYql4OsvRZdg.png)

Register app diyince karşımıza bir config dosyası çıkmakta. Bunu da alarak uygulamamızda **ios/Runner** yoluna koyalım.

![](https://cdn-images-1.medium.com/max/800/1*a7n95pXSTsYn4h-3zDLhWg.png)
...
![](https://cdn-images-1.medium.com/max/800/1*2l5K6HcNTXTmpSTYn91NuQ.png)

#### FCM Consolu

![](https://cdn-images-1.medium.com/max/800/1*LYy2qo_Ij278_Z-WWpLPsQ.png)
...
![](https://cdn-images-1.medium.com/max/800/1*cdD4vZKQXufvvjmHKXgkeg.png)

Bir sonraki adımda bunu göndereceğimiz uygulamayı seçelim.

![](https://cdn-images-1.medium.com/max/800/1*CbLbLOCVMBZl-6ABQlW0sQ.png)
...
![](https://cdn-images-1.medium.com/max/800/1*sPyxgR421sHpJ31ii6394w.png)
...
![](https://cdn-images-1.medium.com/max/800/1*KCNxEfwNJWkioEz_TpMsdA.png)

Şimdi ise ek bazı şeyler soruyor bize. Burayı da bana gerekmediği için ellemiyor ve **Review**’a tıklıyorum.

![](https://cdn-images-1.medium.com/max/800/1*9s6KTaXeUM0icq6pCFJBpg.png)

Karşıma çıkan pencerede son bir kontrol açıyor. Buna da evet diyorum.

![](https://cdn-images-1.medium.com/max/800/1*vAAPk1QrAFEJWtMC0vM4qA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*ilyI1NX2COT6-x2GsPOfow.png)
...
* [**Firebase**:_Backed by Google and loved by app development teams - from startups to global enterprises Save the date - Google I/O…_firebase.google.com](https://firebase.google.com/)

* [**firebase_messaging | Flutter Package**:_A Flutter plugin to use the Firebase Cloud Messaging API. To learn more about Firebase Cloud Messaging, please visit…_pub.dev](https://pub.dev/packages/firebase_messaging)
